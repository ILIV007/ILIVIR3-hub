...
export const timelineEvents: TimelineEvent[] = [
  ...
  {
    id: "7", year: "2025", month: "Sep", monthFa: "سپتامبر",
    title: "AI Admin", titleFa: "AI Admin",
    desc: "Telegram channel content-processing bot on Cloudflare Workers free tier.",
    descFa: "ربات پردازش محتوای کانال تلگرام روی Cloudflare Workers free tier.",
    icon: "bot", highlight: true,
  },
  {
    id: "8", year: "2025", month: "Oct", monthFa: "اکتبر",
    title: "Lyra", titleFa: "Lyra",
    desc: "AI Prompt Optimizer bot with 4-D methodology — multilingual EN/FA/RU.",
    descFa: "ربات بهینه‌ساز پرامپت AI با روش ۴ مرحله‌ای — چندزبانه EN/FA/RU.",
    icon: "sparkles",
  },
  {
    id: "9", year: "2025", month: "Nov", monthFa: "نوامبر",
    title: "Fredy + Pixoris", titleFa: "Fredy + Pixoris",
    desc: "AI Content OS for developer channels, plus Pixoris gaming website.",
    descFa: "سیستم‌عامل محتوای AI برای کانال‌های دولوپر، به‌علاوه سایت گیمینگ Pixoris.",
    icon: "rocket",
  },
  {
    id: "10", year: "2025", month: "Dec", monthFa: "دسامبر",
